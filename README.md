...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/vit-pytorch-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14873&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/vit-pytorch-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `vit-pytorch` can be installed with:

```
conda install vit-pytorch
```

It is possible to list all of the versions of `vit-pytorch` available on your platform with:
