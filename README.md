...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/vit-pytorch-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/vit-pytorch-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add vit-pytorch
# for installing globally
pixi global install vit-pytorch
```
...
It is possible to list all of the versions of `vit-pytorch` available on your platform:
...
```
pixi search vit-pytorch --channel conda-forge
```
